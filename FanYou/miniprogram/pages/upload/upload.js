...
Page({
  ...
  // chooseAndUploadImage1: function (e) {
  //     var that = this;
  //     wx.chooseImage({
  //         count: 1,
  ...
  //       const cloudPath = 'upload/'+this.data.OpenID + filePath.match(/\.[^.]+?$/)[0];
  ...
  //     })
  // },
  // chooseAndUploadImage2: function (e) {
  //   var that = this;
  //   wx.chooseImage({
  //       count: 1,
  //       sizeType: ['original', 'compressed'], // 可以指定是原图还是压缩图，默认二者都有
  ...
  //     console.log("temp file: ",res.tempFilePaths[0])
  //     const filePath = res.tempFilePaths[0];
  //     const cloudPath = 'upload/'+this.data.OpenID+"-1" + filePath.match(/\.[^.]+?$/)[0];
  //     console.log("cloudPath: ",cloudPath)
  //     wx.cloud.uploadFile({
  //       cloudPath: cloudPath,
  //       filePath: filePath, // 文件路径
